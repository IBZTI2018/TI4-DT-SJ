namespace TI4_DT_SJ
{
  partial class StandortForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.button1.Text = "neuen Standort erstellen";
      ...
      this.button2.Text = "alle Standort anzeigen";
      ...
      this.button3.Text = "Standort bearbeiten";
      ...
      this.label4.Text = "Was wollen Sie machen...";
      // 
      // Standort
      // 
      ...
      this.Load += new System.EventHandler(this.Standort_Load);
