...
INSERT INTO person (anrede_id, adresse_id, vorname, nachname, geburtsdatum, email) VALUES
  (
    ...
    (SELECT id FROM adresse WHERE strassenname = 'seestrasse'),
    'Fritz',
    'Meyer',
    '19750301',
  ...
  (
    ...
    (SELECT id FROM adresse WHERE strassenname = 'untermoosstrasse'),
    'Jennifer',
    'Mentner',
    '19971001',
  ...
  (
    (SELECT id FROm anrede WHERE bezeichnung = 'Herr'),
    (SELECT id FROM adresse WHERE strassenname = 'Weihermattstrasse'),
    'Sven',
    'Gehring',
    '19970101',
...
INSERT INTO anbieter (person_id, aufnahmedatum, prov_aufnahmedatum, bonitaetspruefung, unterschrift) VALUES 
  ((SELECT id FROM person WHERE vorname = 'Jennifer'), '20200520', '20200201', 1, 1);

INSERT INTO nachfrager (person_id) VALUES
  ((SELECT id FROM person WHERE vorname = 'Fritz'));

INSERT INTO qualitaetspruefer (person_id, lohn) VALUES
  ((SELECT id FROM person WHERE vorname = 'Jennifer'), 5000);

INSERT INTO bewertung (anbieter_id, nachfrager_id, bezeichnung, score) VALUES
  ((SELECT TOP 1 id FROM anbieter), (SELECT TOP 1 id FROM nachfrager), 'preis ok, aussehen sehr gut', 5);
...
INSERT INTO abo (anbieter_id, aboart_id, abschlussdatum) VALUES
  (
    ...
    (SELECT id FROM aboart WHERE bezeichnung = CONVERT(VARCHAR, 'small')),
    GETDATE()
  );
...
INSERT INTO standplatz (standort_id, standplatz_nr) VALUES
  ((SELECT id FROM standort WHERE bezeichnung = 'Zürich'), 20),
